...
router.get('/web/list/:country/:type', newController.list_frontend);
router.post('/create-razorpay-order', newController.createRazorpayOrder);
router.post('/verify-razorpay-order', newController.verifyRazorpayOrder);
