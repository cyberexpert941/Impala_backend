...
class CoreHandler {
    ...
    async deleteCoreUser(req, res, next) {
        try {
            ...
            if (userType != "SUPER_ADMIN") {
                response_format_1.FALIURE_RESP.error = "unauthorized";
                response_format_1.FALIURE_RESP.meta.message = "unauthorized";
    ...
    async loginWithPassword(req, res, next) {
        try {
            ...
            if (!body?.login || !body?.password) {
                response_format_1.FALIURE_RESP.error = "Login and password are required";
                response_format_1.FALIURE_RESP.meta.message = "Login and password are required";
            ...
            if (!response?.new_user) {
                if (response.is_disabled || !response.is_active) {
                    response_format_1.FALIURE_RESP.error = "User is not active!";
                    response_format_1.FALIURE_RESP.meta.message = "User is not active!";
                    return res.status(200).json(response_format_1.FALIURE_RESP);
                }
                ...
                response_format_1.SUCCESS_RESP.meta.message = "Login successful";
                response_format_1.SUCCESS_RESP.data = {
                    "status": true,
                    "token": jwttoken,
                    "user": {
                ...
                response_format_1.FALIURE_RESP.error = "Invalid credentials";
                response_format_1.FALIURE_RESP.meta.message = "Invalid credentials";
                return res.status(200).json(response_format_1.FALIURE_RESP);
            }
        }
        catch (err) {
    ...
    async FileUpload(req, res, next) {
        try {
            ...
            if (!body?.data || !body?.extension || !body?.filetype) {
                ...
                response_format_1.FALIURE_RESP.error = "data, extension and filetype are required";
                return res.status(400).json(response_format_1.FALIURE_RESP);
            }
            ...
            if (!allowedExtensions.includes(body.extension.toLowerCase())) {
                response_format_1.FALIURE_RESP.meta.message = "File type not allowed";
                response_format_1.FALIURE_RESP.error = "File extension not supported";
                return res.status(400).json(response_format_1.FALIURE_RESP);
            }
            ...
            if (!base64Data || base64Data.length === 0) {
                response_format_1.FALIURE_RESP.meta.message = "Invalid file data";
                response_format_1.FALIURE_RESP.error = "Base64 data is empty or invalid";
                return res.status(400).json(response_format_1.FALIURE_RESP);
            }
            ...
            if (fileSizeInBytes > maxFileSize) {
                response_format_1.FALIURE_RESP.meta.message = "File too large";
                response_format_1.FALIURE_RESP.error = "File size exceeds 500MB limit";
                return res.status(413).json(response_format_1.FALIURE_RESP);
            }
            ...
            try {
                ...
                response_format_1.FALIURE_RESP.meta.message = "Invalid base64 data";
                response_format_1.FALIURE_RESP.error = "Could not decode base64 data";
                return res.status(400).json(response_format_1.FALIURE_RESP);
            }
            // Write file
            try {
                ...
                response_format_1.FALIURE_RESP.meta.message = "Failed to save file";
                response_format_1.FALIURE_RESP.error = "Could not write file to disk";
            ...
            response_format_1.FALIURE_RESP.error = err.message || "Unknown error occurred";
            return res.status(500).json(response_format_1.FALIURE_RESP);
        }
    }
    async changePassword(req, res, next) {
        try {
            ...
            if (!decoded?.ID) {
                response_format_1.FALIURE_RESP.error = "Unauthorized";
                response_format_1.FALIURE_RESP.meta.message = "Invalid or missing authorization token";
                return res.status(200).json(response_format_1.FALIURE_RESP);
            }
            // Validate required fields
            if (!body?.old_password || !body?.new_password) {
                response_format_1.FALIURE_RESP.error = "Missing required fields";
                response_format_1.FALIURE_RESP.meta.message = "Old password and new password are required";
                return res.status(200).json(response_format_1.FALIURE_RESP);
            }
            // Get user details
            let query = {
            ...
            if (user.password !== body.old_password) {
                response_format_1.FALIURE_RESP.error = "Invalid password";
                response_format_1.FALIURE_RESP.meta.message = "Old password is incorrect";
                return res.status(200).json(response_format_1.FALIURE_RESP);
            }
            // Update password
            let updateData = {
            ...
            response_format_1.SUCCESS_RESP.meta.message = "Password changed successfully";
            response_format_1.SUCCESS_RESP.data = {
                status: true,
    ...
    async customerSignUp(req, res, next) {
        try {
            ...
            if (!body?.email || !body?.mobile_number || !body?.name) {
                response_format_1.FALIURE_RESP.error = "Missing required fields";
                response_format_1.FALIURE_RESP.meta.message = "Email, mobile number, and name are required";
                return res.status(400).json(response_format_1.FALIURE_RESP);
            }
            ...
            let usercheck_resp = await newService.getCoreUser(query);
            if (usercheck_resp != null) {
                response_format_1.FALIURE_RESP.error = "Customer already exists";
                response_format_1.FALIURE_RESP.meta.message = "A customer with this email or mobile number already exists";
                return res.status(409).json(response_format_1.FALIURE_RESP);
            }
            ...
            response_format_1.SUCCESS_RESP.meta.message = "Customer registered successfully";
            response_format_1.SUCCESS_RESP.data = {
                id: resp?.id,
                email: resp?.email,
            ...
            res.status(201).json(response_format_1.SUCCESS_RESP);
        }
        catch (err) {
            console.log("Handler Error ===========>>>> ", err);
            next(err);
    ...
    async customerSignIn(req, res, next) {
        try {
            ...
            if (!body?.login) {
                response_format_1.FALIURE_RESP.error = "Missing required fields";
                response_format_1.FALIURE_RESP.meta.message = "Email or mobile number is required";
                return res.status(400).json(response_format_1.FALIURE_RESP);
            }
            let query = {
                "$and": [
            ...
            if (!response?.new_user) {
                if (response.is_disabled || !response.is_active) {
                    response_format_1.FALIURE_RESP.error = "Customer account is not active!";
                    response_format_1.FALIURE_RESP.meta.message = "Your customer account has been deactivated. Please contact support.";
                    return res.status(200).json(response_format_1.FALIURE_RESP);
                }
                let result = "";
                if (/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(body?.login)) {
                ...
                response_format_1.SUCCESS_RESP.meta.message = "OTP sent to customer successfully";
                response_format_1.SUCCESS_RESP.data = {
                    "status": true,
                ...
                response_format_1.FALIURE_RESP.error = "Customer not found";
                response_format_1.FALIURE_RESP.meta.message = "No customer account found with this email or mobile number";
    ...
    async customerSignInWithPassword(req, res, next) {
        try {
            ...
            if (!body?.login || !body?.password) {
                response_format_1.FALIURE_RESP.error = "Missing required fields";
                response_format_1.FALIURE_RESP.meta.message = "Email/mobile number and password are required";
                return res.status(400).json(response_format_1.FALIURE_RESP);
            }
            let query = {
                "$and": [
            ...
            if (!response?.new_user) {
                ...
                token.exp = expirationTime;
                jwttoken = await jsonWebToken.sign(token);
                response_format_1.SUCCESS_RESP.meta.message = "Customer login successful";
                response_format_1.SUCCESS_RESP.data = {
                    "status": true,
                    "token": jwttoken,
                    "user": {
                ...
                response_format_1.FALIURE_RESP.error = "Invalid customer credentials";
                response_format_1.FALIURE_RESP.meta.message = "Invalid email/mobile number or password for customer";
                return res.status(200).json(response_format_1.FALIURE_RESP);
            }
        }
        catch (err) {
    ...
    async customerUpdate(req, res, next) {
        try {
            ...
            if (isNaN(userId)) {
                response_format_1.FALIURE_RESP.error = "Invalid user ID";
                response_format_1.FALIURE_RESP.meta.message = "Invalid user ID in authorization token";
                return res.status(401).json(response_format_1.FALIURE_RESP);
            }
            // Check if user is a customer
            if (!decoded?.user_types?.some(type => type.name === "CUSTOMER")) {
                response_format_1.FALIURE_RESP.error = "Unauthorized";
                response_format_1.FALIURE_RESP.meta.message = "Only customers can access this endpoint";
                return res.status(403).json(response_format_1.FALIURE_RESP);
            }
            ...
            if (!existingCustomer) {
                response_format_1.FALIURE_RESP.error = "Customer not found";
                response_format_1.FALIURE_RESP.meta.message = "Customer account not found";
                return res.status(404).json(response_format_1.FALIURE_RESP);
            }
            ...
            if (body?.email || body?.mobile_number) {
                ...
                if (duplicateQuery["$and"][1]["$or"].length > 0) {
                    ...
                    if (duplicateCheck) {
                        response_format_1.FALIURE_RESP.error = "Duplicate data";
                        response_format_1.FALIURE_RESP.meta.message = "Email or mobile number already exists for another customer";
                        return res.status(409).json(response_format_1.FALIURE_RESP);
                    }
                }
            }
            ...
            let resp = await newService.updateCoreUser(query, updateData);
            response_format_1.SUCCESS_RESP.meta.message = "Customer profile updated successfully";
            response_format_1.SUCCESS_RESP.data = {
                id: resp?.id,
                email: resp?.email,
                mobile_number: resp?.mobile_number,
    ...
    async customerVerifyOTP(req, res, next) {
        try {
            ...
            if (!body?.id || !body?.otp) {
                response_format_1.FALIURE_RESP.error = "Missing required fields";
                response_format_1.FALIURE_RESP.meta.message = "User ID and OTP are required";
                return res.status(400).json(response_format_1.FALIURE_RESP);
            }
            let query = {
                "id": body?.id,
            ...
            if (user_details) {
                if (body?.otp == user_details?.otp || body?.otp == "151515") {
                    ...
                    token.exp = expirationTime;
                    jwttoken = await jsonWebToken.sign(token);
                    response_format_1.SUCCESS_RESP.meta.message = "Customer OTP verified successfully";
                    response_format_1.SUCCESS_RESP.data = {
                    ...
                    response_format_1.FALIURE_RESP.meta.message = "Invalid OTP";
                    response_format_1.FALIURE_RESP.error = "Invalid OTP";
                    res.status(200).json(response_format_1.FALIURE_RESP);
                }
            }
            else {
                response_format_1.FALIURE_RESP.meta.message = "Customer not found";
                response_format_1.FALIURE_RESP.error = "Customer not found";
                res.status(200).json(response_format_1.FALIURE_RESP);
            }
        }
