    ...
    async list(req, res, next) {
        try {
            ...
            if (!(typeof query?.search === 'undefined')) {
                search_or_conditions.push({ "product_name": new RegExp(`.*${query?.search}.*`, 'i') });
                search_or_conditions.push({ "product_description": new RegExp(`.*${query?.search}.*`, 'i') });
            ...
            if (!(typeof query?.category === 'undefined')) {
                and_conditions.push({ "product_category": query?.category });
            }
